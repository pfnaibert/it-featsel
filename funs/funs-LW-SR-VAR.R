...
# LAST MODIFIED: 20 of October of 2019
##########################

##########################
#' utility function to test the difference in statistics
hac.test <- function(ret, est, rav=1, kernel="parzen", pw=0) 
{
...
#
cat("\n ========================== ")
cat("\n *** Bootstrap for", est, ", block length:", b, ", with", M, "Iterations ***")
for(m in (1:M))
{

#
if(m%%500==0){cat("\n *** Bootstrap for", est, ", block length:", b, ", Iteration:", m, "out of", M, "***")}
